...
$(function () {
  ...
  $('#menu-navegacion .navbar-nav a').click(function(){
    ...
    /* ---------------------------------------
    4. FUNCIONES PARA INICIAR jQuery.CounterUp
    -----------------------------------------*/

    $('.counter').counterUp();

    /* ---------------------------------------
    5. FUNCIONES PARA INICIAR pickadate picker.date.js
    -----------------------------------------*/
    ...
    /* ---------------------------------------
    6. FUNCIONES PARA INICIAR pickadate picker.time.js
    -----------------------------------------*/
    ...
    /* ---------------------------------------
    7. FUNCIONES PARA INICIAR parsley.js
    -----------------------------------------*/    
    ...
    $('#form-contacto').parsley({
      ...
      if (successClass = 'is-valid') {
        console.log('todo COOOOOOOREEECTOOOOO');
      },
    ...
    /* ---------------------------------------
    8. FUNCIONES PARA INICIAR jQuery.stickit.min.js
    -----------------------------------------*/  
    ...
    /* ---------------------------------------
    9. FUNCIONES PARA INICIAR Scroll2id.js
    -----------------------------------------*/ 

    $('#menu-principal a, #pie-de-pagina a, #menu-navegacion a, #slider-principal a').mPageScroll2id({
      offset:'65',
      highlightClass:'active',
    });

    /* ---------------------------------------
    9. FUNCIONES PARA INICIAR Jarallax.js
    -----------------------------------------*/ 
    $('.jarallax').jarallax({
      speed: 0.5
  });
